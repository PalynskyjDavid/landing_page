...
export const frontendURL = "http://127.0.0.1:5188";
export const backendURL = `${frontendURL}/api`;
export const directBackendURL = "http://127.0.0.1:3107";
export const docsURL = "http://127.0.0.1:5197";
...
export const testEnvironment = {
  ...
  BACKEND_PORT: "3107",
  CORS_ORIGIN: "http://127.0.0.1:5187",
  COOKIE_SECURE: "false",
  VITE_API_URL: directBackendURL,
};
